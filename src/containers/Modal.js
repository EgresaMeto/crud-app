          ...
          <div className='relative w-auto my-6 mx-auto max-w-3xl'>
            ...
            <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
              ...
              <div className='relative p-6 flex  flex-col'>
                <div>{selectedPost.id && `Id: ${selectedPost.id}`}</div>
                <label className='bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Usernameshadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username'>
                  Title:
                  <input
                    type='text'
                    value={title}
              ...
              <div className='flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b'>
                ...
                <button
                  ...
                  onClick={() => {
                    if (selectedPost.id) {
                      return handleUpdate(selectedPost.id, title, body)
                    }
